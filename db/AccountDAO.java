...
public class AccountDAO {
    ...
    private Account mapResultSetToAccount(ResultSet rs, CustomerDAO customerDAO) throws SQLException {
        ...
        switch (accountType) {
            case "SAVINGS":
                return new SavingsAccount(customer, branch, balance) {
                    @Override
                    public String getAccountNumber() { return accountNumber; }
                };

            case "INVESTMENT":
                return new InvestmentAccount(customer, branch, balance) {
                    @Override
                    public String getAccountNumber() { return accountNumber; }
                };
            ...
            case "CHEQUE":
                ...
                return new ChequeAccount(customer, branch, balance, employerName, employerAddress) {
                    @Override
                    public String getAccountNumber() { return accountNumber; }
                };
